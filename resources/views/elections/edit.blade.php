                    ...
                    <form action="{{ route('elections.update', $election->id) }}" method="post">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text"
                                   ...
                                   id="title" name="title" placeholder="Enter title" value="{{ $election->title }}"
                                   required>
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control {{ $errors->has('description') ? ' is-invalid' : '' }}"
                                      name="description"
                                      id="description" rows="10">{{ $election->description }}</textarea>
                        ...
                        <div class="form-group">
                            ...
                            <select name="type" id="type" class="form-control" required>
                                ...
                                <option value="National" @if($election->type == 'National') selected @endif>National</option>
                                <option value="City" @if($election->type == 'City') selected @endif>City</option>
                            </select>
                        ...
                        <div class="form-check">
                            <input type="checkbox"
                                   ...
                                   id="is_active" name="is_active" @if($election->is_active) checked @endif>
