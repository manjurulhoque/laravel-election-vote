                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('candidate.register.submit') }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="dob" type="text" readonly
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="nid" type="number" maxlength="16"
                                       class="form-control @error('nid') is-invalid @enderror" name="nid"
                                       value="{{ old('nid') }}" required autocomplete="nid">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="mobile" type="number" maxlength="11"
                        ...
                        <div class="form-group row">
                            <label for="is_married" class="col-md-4 col-form-label text-md-right">{{ __('Marital status') }}</label>
